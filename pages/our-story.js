...
const timelineEvents = [
  {
    year: '2022',
    title: 'First Meeting — Kogi State',
    text: 'We met during our NYSC service year through a writing community in Kogi State. Two kindred spirits brought together by words and purpose.',
    icon: '✍️',
  },
  {
    year: '2022',
    title: 'NCCF Fellowship',
    text: 'We grew closer through NCCF fellowship activities. Posted to the same local government, we stayed in the same corpers\' lodge — building friendship daily.',
    icon: '🙏',
  },
  {
    year: '2023',
    title: 'Separate Paths',
    text: 'After NYSC, life took us in different directions. We went our separate ways, not knowing God was writing a greater story.',
    icon: '🛤️',
  },
  {
    year: '2024',
    title: 'Divine Reconnection',
    text: 'At the RCCG Youth Convention at Redemption City, Ogun State, God orchestrated our reunion. From that moment, friendship blossomed into something deeper.',
    icon: '✨',
  },
  {
    year: '2025',
    title: 'Intentional Courtship',
    text: 'Through prayer, shared values, and God\'s guidance, our relationship grew into intentional courtship — two hearts aligned toward one purpose.',
    icon: '💍',
  },
  {
    year: '2026',
    title: 'Forever Begins',
    text: 'On 15th August 2026, surrounded by family and friends, we say "I do" — beginning a beautiful union rooted in love, faith, and purpose.',
    icon: '💒',
  },
];
    ...
    <Layout title="Our Story | Lydia & Ndiana">
        ...
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '40px' }}>
            ...
            <div className="card" style={{ textAlign: 'center' }}>
              ...
              <p style={{ color: 'var(--text-mid)', lineHeight: 1.8, fontSize: '0.95rem', marginTop: '12px' }}>
                She believes everyone has a God-given purpose worth discovering and is committed to helping people live meaningfully.
              </p>
            </div>
            ...
            <div className="card" style={{ textAlign: 'center' }}>
              ...
              <p style={{ color: 'var(--text-mid)', lineHeight: 1.8, fontSize: '0.95rem', marginTop: '12px' }}>
                Together, they are a testimony that God's timing is always perfect — and His love stories are the most beautiful of all.
              </p>
            </div>
          </div>
        </div>
                ...
                <div style={{ flex: 1 }}>
                  <div className="card" style={{ padding: '28px' }}>
                    ...
                    <h4 style={{
                      ...
                      color: 'var(--emerald-dark)', marginBottom: '10px',
                    }}>{event.title}</h4>
      ...
      <section className="section-sm" style={{ background: 'var(--emerald-dark)', textAlign: 'center' }}>
        <div className="container">
          <div style={{
            fontFamily: "'Great Vibes', cursive",
            fontSize: '3rem', color: 'var(--gold-light)', marginBottom: '16px',
          }}>
            Join Us
          </div>
