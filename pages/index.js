...
export default function Home() {
  return (
    <Layout title="Lydia & Ndiana | Divine's Choice '26">
      ...
      <section style={{
        minHeight: '100vh',
        background: 'linear-gradient(160deg, var(--emerald-dark) 0%, var(--emerald) 50%, #1e7a54 100%)',
        display: 'flex',
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div className="fade-up-delay-4" style={{
            ...
            <Link href="/wedding-details" className="btn btn-gold">
              View Wedding Details
            </Link>
            <Link href="/rsvp" className="btn btn-outline-white">
              RSVP Now
            </Link>
        ...
        <div style={{
          ...
          <div style={{
            width: '1px', height: '40px', background: 'linear-gradient(to bottom, white, transparent)',
          ...
          <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap', justifyContent: 'center', margin: '48px 0' }}>
            {[
              ...
              <div key={label} className="card" style={{
                flex: '1 1 220px', maxWidth: '280px', textAlign: 'center',
                padding: '32px 24px',
              }}>
                ...
                <div style={{
                  fontFamily: "'Cormorant Garamond', serif",
                  fontSize: '1.2rem', fontWeight: 600, color: 'var(--emerald-dark)',
                }}>{value}</div>
      ...
      <section className="section" style={{
        background: 'linear-gradient(135deg, var(--emerald-muted) 0%, var(--gold-pale) 100%)',
      }}>
          ...
          <div style={{
            ...
            <div style={{ position: 'relative' }}>
              <div style={{
                ...
                fontSize: '1.1rem',
                fontStyle: 'italic',
                boxShadow: '0 20px 60px rgba(26,107,74,0.25)',
              }}>
                <span style={{ fontSize: '3rem', marginBottom: '8px', opacity: 0.4 }}>💑</span>
            ...
            <div>
              ...
              <p style={{ color: 'var(--text-mid)', marginBottom: '32px', lineHeight: 1.8 }}>
                After NYSC, we went separate ways but God had other plans. A reconnection at RCCG Youth Convention at Redemption City was the beginning of something beautiful — friendship, prayer, and intentional courtship.
              </p>
            ...
            {[
              ...
              <Link key={href} href={href} style={{ textDecoration: 'none' }}>
                ...
                >
                  ...
                  <div style={{
                    fontFamily: "'Cormorant Garamond', serif",
                    fontSize: '1.15rem', fontWeight: 600, color: 'white', marginBottom: '6px',
                  }}>{label}</div>
